		...
		<div class="right_min">
			<div class="crumbs_nav">
				...
				<ul>
					...
					<li> > </li>
					<li><a href="javascript:void(0);">学员VIP统计</a></li>
				</ul>
			</div>
			<div class="min">
				<!--查询-->
				...
				<div class="query">
					<form  name="seachform" id="seachform"  action="<?php echo U('tongji/vipinfo');?>"  method="post" class="form"  onsubmit="return checkkwd()">
						...
						<div class="button mg_trb">
							...
							<input type="button" value="重置" class="but chongzhi" onclick="location.href='<?php echo U('tongji/vipinfo');?>'"/>
						</div>
