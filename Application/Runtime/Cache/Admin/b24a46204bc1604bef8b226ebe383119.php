		...
		<div class="right_min">
			<div class="crumbs_nav">
				...
				<ul>
					...
					<li> > </li>
					<li><a href="javascript:void(0);">课程专题评论统计</a></li>
				</ul>
			</div>
			<div class="min">
				<!--查询-->
				...
				<div class="query">
					<form  name="seachform" id="seachform"  action="<?php echo U('tongji/commentcount');?>"  method="post" class="form"  onsubmit="return checkkwd()">
						<div class="form_input mg_trb">
							<label class="text">快速检索</label>
							<input type="text" name="info[keyword]" id="keyword" value="<?php echo ($keyword); ?>"  placeholder="请输入用户姓名或手机号或课程"  maxlength="11"/>
						</div>
						...
						<div class="button mg_trb">
							...
							<input type="button" value="重置" class="but chongzhi" onclick="location.href='<?php echo U('tongji/commentcount');?>'"/>
						</div>
