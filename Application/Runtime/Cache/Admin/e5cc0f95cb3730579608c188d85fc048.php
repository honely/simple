...
<html>
	...
	<body>
		<div class="right_min">
			...
			<div class="min">
				<div class="form_box">
					<form name="myform" id="myform" action="<?php echo U('adminmenu/addmenuinfo');?>" method="post">
						<div class="form-item">
							<label class="form-label">菜单名</label>
							<div class="form-text form-input-block">
								<input type="text"name="info[menu_name]" id="menu_name" type="text" class="dfinput" datatype="*2-30" errormsg="菜单名范围在2~30位之间！" maxlength="15" />
						...
						<div class="form-item">
							...
							<div class="form-text form-input-block">
								<input type="text" name="menu_father_title" id="menu_father_title" type="text" class="dfinput" datatype="*"  maxlength="15" value="<?php echo ($father_menuinfo["menu_name"]); ?>" readonly  />
								<i class="Validform_checktip"></i>
						...
						<div class="form-item">
							...
							<div class="form-text form-input-block">
								<input name="info[menu_controller]" id="menu_controller" type="text" class="dfinput" datatype="s2-20" errormsg="控制器范围在2~20位之间！" maxlength="15" value="" /><i class="Validform_checktip"></i>
							</div>
						</div>
						<div class="form-item">
							<label class="form-label">方法</label>
							<div class="form-text form-input-block">
								<input name="info[menu_action]" id="menu_action" type="text" class="dfinput" datatype="s2-20" errormsg="方法范围在2~20位之间！" maxlength="15" value="" /><i class="Validform_checktip"></i>
							</div>
						</div>
						<div class="form-item">
							<label class="form-label">菜单图标</label>
							<div class="form-text form-input-block">
								<input name="info[menu_icon]" id="menu_icon" type="text" class="dfinput" datatype="*2-20" errormsg="菜单图标范围在2~20位之间！" maxlength="15" value="" /><i class="Validform_checktip"></i>
							</div>
						</div>
						<div class="form-item">
							<label class="form-label">排序</label>
							<div class="form-text form-input-block">
								<input name="info[sort]" id="sort" type="text" class="dfinput" datatype="/^[1-9]\d*|0$/" errormsg="控制器范围在1~5位之间！" maxlength="5" value="0" /><i class="Validform_checktip"></i>
							</div>
						</div>
