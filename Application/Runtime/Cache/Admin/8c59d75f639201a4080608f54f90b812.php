        ...
        <div class="right_min">
            <div class="crumbs_nav">
                ...
                <ul>
                    ...
                    <li> > </li>
                    <li><a href="javascript:void(0);">问答评论的评论审核</a></li>
            ...
            <div class="min">
                <!--查询-->
                <div class="query">
                    <form name="seachform" id="seachform" action="<?php echo U('forum/forum2');?>"  method="post" class="form">
                        ...
                        <div class="button mg_trb">
                            ...
                            <input type="button" value="重置" class="but chongzhi" onclick="location.href = '<?php echo U('forum/forum2');?>'"/>
                        </div>
                        <div class="button mg_trb">
				...
				<td><?php echo (date("Y-m-d H:i:s",$content["addtime2"])); ?></td> 
                                <td>   
                                    <a href="<?php echo U('forum/passtwo',array('comment2_id'=>$content['comment2_id']));?>" onclick="{
                                                if (confirm('确认审核?')) {
                                                    return true;
                                                }
                                                return false;
                                    ...
                                    <a href="<?php echo U('forum/delpasstwo',array('comment2_id'=>$content['comment2_id']));?>" onclick="{
                                                                                    if (confirm('确认删除?')) {
                                                                                        return true;
                                                                                    }
                                                                                    return false;
