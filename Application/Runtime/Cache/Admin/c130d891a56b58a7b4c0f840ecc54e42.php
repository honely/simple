			...
			<div class="min">
				<div class="form_box">
						...
						<div class="form-item">
							...
							<div class="form-text form-input-block">
								<input type="text" name="menu_father_title" id="menu_father_title" type="text" class="dfinput" datatype="*2-30" errormsg="菜单名范围在2-30位之间！" maxlength="30" value="<?php echo ($father_menuinfo["menu_name"]); ?>" readonly  />
								<i class="Validform_checktip"></i>
						...
						<div class="form-item">
							...
							<div class="form-text form-input-block">
								<input name="info[sort]" id="sort" type="text" class="dfinput" datatype="/^[1-9]\d*|0$/" errormsg="控制器范围在1~5位之间！"  maxlength="5" value="<?php echo ($adminmenu["sort"]); ?>"  /><i class="Validform_checktip"></i>
							</div>
						</div>
