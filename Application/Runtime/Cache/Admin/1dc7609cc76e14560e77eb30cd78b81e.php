        ...
        <div class="right_min">
            <div class="crumbs_nav">
                ...
                <ul>
                    ...
                    <li> > </li>
                    <li><a href="###">编辑课程专题</a></li>
                </ul>
            </div>
            <div class="min">
                <div class="form_box">
                    <form  name="myform" id="myform" action="<?php echo U('course/editcourse',array('id'=>$course['course_id']));?>" method="post" onsubmit="return check()">
                        <div class="form-item">
                            <label class="form-label">专题名称</label>
                            <div class="form-text form-input-block">
                                <input type="text" name="info[course_name]" value="<?php echo ($course["course_name"]); ?>" placeholder="请输入专题名称" id="course_name" maxlength="60"/>
						...
						<div class="form-item">
                            ...
                            <div class="form-text form-input-block">
                                <input type="text" name="info[course_remarks]" value="<?php echo ($course["course_remarks"]); ?>" placeholder="请输入专题简介" id="course_remarks" maxlength="100"/>
                        ...
                        <div class="form-item">
                            ...
                            <div class="form-select form-input-block">
                                <select id="classify_id" name="info[classify_id]">
                                    ...
                                    <?php if(is_array($classifies)): $i = 0; $__LIST__ = $classifies;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><option value="<?php echo ($data["classify_id"]); ?>" <?php if($data['classify_id'] == $course["classify_id"] ): ?>selected<?php endif; ?>><?php echo ($data["classify_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                        ...
                        <div class="form-item">
                            ...
                            <div class="form-text form-input-inline w40">
                                <input type="text"  name="info[course_images]" id="course_images"  maxlength="255" readonly value="<?php echo ($course["course_images"]); ?>"/>
                            </div>
                            ...
                            <div class="form-text form-input-block w50">
                                <ul class="toollist_pic c" id="toollist_pic">
                                    <?php if(is_array($course_images)): $i = 0; $__LIST__ = $course_images;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$image): $mod = ($i % 2 );++$i;?><li onclick="del_album_img('<?php echo ($image); ?>',this)"><a><img src="<?php echo ($image); ?>"><i class="fa fa-times-circle"></i></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="form-item" style="display:none">
                            ...
                            <div class="form-text form-input-inline w40">
                                <input type="text"  name="info[course_ppt]" id="course_ppt"  maxlength="255" readonly value="<?php echo ($course["course_ppt"]); ?>"/>
                            </div>
                            <div class="form-button form-input-inline">
                            ...
                            <div class="form-text form-input-block w50">
                                <ul class="toollist_pic c" id="toollist_pic_ppt">
                                    <?php if(is_array($course_ppt)): $i = 0; $__LIST__ = $course_ppt;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ppt): $mod = ($i % 2 );++$i;?><li onclick="del_album_img_ppt('<?php echo ($ppt); ?>',this)"><a><img src="<?php echo ($ppt); ?>"><i class="fa fa-times-circle"></i></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="form-item">
                            ...
                            <div class="form-text form-input-block w50">
                                <input type="text" name="info[course_money]"  value="<?php echo ($course["course_money"]); ?>" placeholder="请输入年费" id="course_money" onkeyup="this.value = this.value.replace(/[^\d\.]/g, '')" maxlength="6"/>
                        ...
                        <div class="form-item">
                            ...
                            <div class="form-text form-input-block w50">
                                <input type="text" name="info[course_limit]" value="<?php echo ($course["course_limit"]); ?>" placeholder="请输入抢购价" id="course_limit" onkeyup="this.value = this.value.replace(/[^\d\.]/g, '')" maxlength="6"/>
                        ...
                        <div class="form-item">
                            ...
                            <div class="form-text form-input-block w50">
                                <input readonly type="text" name="info[course_limittime]" value='<?php echo (date("Y-m-d H:i:s",$course["course_limittime"])); ?>' placeholder="请选择截止时间" id="course_limittime"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"/>
                        ...
                        <div class="form-item">
                            ...
                            <div class="form-text form-input-block">
                                <input type="text" name="info[course_allparts]"  value="<?php echo ($course["course_allparts"]); ?>" placeholder="请输入总集数" id="course_allparts" maxlength="5" onkeyup="this.value = this.value.replace(/[^\d]/g, '')"/>
						...
						<div class="form-item">
                            ...
                            <div class="form-text form-input-block">
                                <input type="text" name="info[course_partremarks]" value="<?php echo ($course["course_partremarks"]); ?>" placeholder="请输入集数更新说明" id="course_partremarks" maxlength="20"/>
                        ...
                        <div class="form-item" style="display:none">
                            ...
                            <div class="form-text form-input-block">
                                <input type="text" name="info[course_speaker]"  value="<?php echo ($course["course_speaker"]); ?>" placeholder="请输入主讲老师" id="course_speaker" maxlength="12"/>
                        ...
                        <div class="form-item" style="display:none">
                            ...
                            <div class="form-textarea form-input-block">
                                <textarea name="info[speaker_remarks]" placeholder="请输入讲师介绍" id="speaker_remarks" maxlength="500"><?php echo ($course["speaker_remarks"]); ?></textarea>
                        ...
                        <div class="form-item">
                            ...
                            <div class="form-textarea form-input-block">
                                <textarea name="info[course_content]" placeholder="请输入专题内容" id="course_content" maxlength="600"><?php echo ($course["course_content"]); ?></textarea>
						...
						<div class="form-item">
                            ...
                            <div class="form-radio form-input-block">
                                <div class="skin-section">
                                    <ul>
                                        <li>
                                            <input type="radio" name="info[course_showmoney]" value="1"  <?php if(1 == $course["course_showmoney"] ): ?>checked<?php endif; ?> >
                                            <span>不显示</span>
                                        </li>
                                        <li>
                                            <input  type="radio" name="info[course_showmoney]" value="2" <?php if(2 == $course["course_showmoney"] ): ?>checked<?php endif; ?>>
                                            <span>显示</span>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="form-item">
                            ...
                            <div class="form-text form-input-block w50">
                                <input type="text" name="info[course_sort]"  value="<?php echo ($course["course_sort"]); ?>" placeholder="请输入排序" id="course_sort" maxlength="5" onkeyup="this.value = this.value.replace(/[^\d]/g, '')"/>
