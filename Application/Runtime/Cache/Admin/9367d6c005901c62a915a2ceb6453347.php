...
<html>
	...
	<body>
		<div class="right_min">
			...
			<div class="min">
				<div class="form_box">
					<form name="myform" id="myform" action="<?php echo U('workinfo/addinfo');?>" method="post">
						<div class="form-item">
						...
						<div class="form-item">
							...
							<div class="form-textarea form-input-block">
								<textarea style="width: 60%" name="info[work_content]" placeholder="请输入内容" id="content" maxlength="255"  datatype="*"/></textarea>
								<i class="Validform_checktip"></i>
							</div>
						</div>
						<div class="form-item">
