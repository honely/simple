		...
		<div class="right_min">
			<div class="crumbs_nav">
				...
				<ul>
					...
					<li> > </li>
					<li><a href="javascript:void(0);">其它管理</a></li>
					<li> > </li>
					<li><a href="<?php echo U('workinfo/workoper');?>">研发班管理</a></li>
					<li> > </li>
					<li><a href="<?php echo U('workinfo/edit');?>">修改</a></li>
				</ul>
			</div>
			<div class="min">
				<div class="form_box">
						<form name="myform" id="myform" action="<?php echo U('workinfo/edit',array('work_id'=>$classify['work_id']));?>" method="post">
						<div class="form-item">
							<label class="form-label">研习班名称</label>
							<div class="form-text form-input-block">
								<input type="text" name="info[work_title]" id="work_title"  datatype="*2-30" errormsg="研发班名称为2-30位！" maxlength="30" value="<?php echo ($classify["work_title"]); ?>"/>
						...
						<div class="form-item">
							...
							<div class="form-text form-input-block">
								<input type="text" name="info[work_video]" id="work_video"  datatype="*5-100" errormsg="研习班视频为5-100位！" maxlength="100" value="<?php echo ($classify["work_video"]); ?>"/>
								<i class="Validform_checktip"></i>
						...
						<div class="form-item">
							...
							<div class="form-text form-input-block">
								<input type="text" name="info[work_address]" id="work_address"  datatype="*2-50" errormsg="研习班地址为2-50位！" maxlength="50" value="<?php echo ($classify["work_address"]); ?>"/>
								<i class="Validform_checktip"></i>
							</div>
						</div>
						<div class="form-item">
							...
							<div class="form-text form-input-block">
								<input type="text" name="info[work_time]" id="work_time"  datatype="*5-30" errormsg="研发班时间为5-30位！" maxlength="30" value="<?php echo ($classify["work_time"]); ?>"/>
								<i class="Validform_checktip"></i>
							</div>
						</div>
				        <div class="form-item">
							...
							<div class="form-textarea form-input-block">
								 <textarea style="width: 60%" name="info[work_content]" id="content" maxlength="255"  datatype="*"><?php echo ($classify["work_content"]); ?></textarea>
								<i class="Validform_checktip"></i>
							</div>
						</div>
						<div class="form-item">
							<div class="form-button form-input-block">
								...
								<button class="but chongzhi" type="button" onclick="location.href='<?php echo U('workinfo/workoper');?>'">返回</button>
							</div>
						</div>
					</form>
				</div>
