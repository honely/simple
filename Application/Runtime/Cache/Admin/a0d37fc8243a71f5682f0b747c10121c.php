		...
		<div class="right_min">
			<div class="crumbs_nav">
				...
				<ul>
					...
					<li> > </li>
					<li><a href="javascript:void(0);">专题订阅统计</a></li>
				</ul>
			</div>
			<div class="min">
				<!--查询-->
					...
					<table class="table" border="" cellspacing="" cellpadding="">
						...
						<tbody>
							<?php if(is_array($infolist)): $i = 0; $__LIST__ = $infolist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><tr>
								...
								<td><?php echo ($info["course_buy"]); ?></td>
								<td><?php echo (date("Y-m-d H:i:s",$info["course_retime"])); ?></td>
								<td><?php echo ($info["course_speaker"]); ?></td>
