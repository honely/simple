        ...
        <div class="right_min">
            <div class="crumbs_nav">
                ...
                <ul>
                    ...
                    <li> > </li>
                    <li><a href="<?php echo U('course/index');?>">专题课程管理</a></li>
                    <li> > </li>
                    <li><a href="###">添加专题课程</a></li>
                </ul>
            </div>
            <div class="min">
                <div class="form_box">
                    <form  name="myform" id="myform" action="<?php echo U('lesson/addlesson',array('course_id'=>$course_id));?>" method="post" onsubmit="return checkfrom()">
                        <div class="form-item">
                       ...
                       <div class="form-item">
                            ...
                            <div class="form-radio form-input-block">
                                <div class="skin-section">
                                    <ul>
                                        <li>
                                            <input type="radio" name="info[lesson_ishot]" value="1"  checked >
                                            <span>非热播</span>
                                        </li>
                                        <li>
                                            <input  type="radio" name="info[lesson_ishot]" value="2">
                                            <span>热播</span>
                                        </li>
                                    </ul>
                                </div>
						...
						<div class="form-item">
                            ...
                            <div class="form-radio form-input-block">
                                <div class="skin-section">
                                    <ul>
                                        <li>
                                            <input type="radio" name="info[lesson_showmoney]" value="1"  checked>
                                            <span>不显示</span>
                                        </li>
                                        <li>
                                            <input  type="radio" name="info[lesson_showmoney]" value="2" >
                                            <span>显示</span>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <div class="form-item">
                            <div class="form-button form-input-block">
								...
								<button class="but chongzhi" type="button" onclick="location.href='<?php echo U('lesson/index',array('course_id'=>$course_id));?>'">返回</button>
                            </div>
                        </div>
                    </form>
                </div>
