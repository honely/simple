		...
		<div class="right_min">
			<div class="crumbs_nav">
				...
				<ul>
					...
					<li> > </li>
					<li><a href="javascript:void(0);">添加配置</a></li>
				</ul>
			</div>
			<div class="min">
				<div class="form_box">
					<form name="myform" id="myform" action="<?php echo U('set/addinfo');?>" method="post">
						<div class="form-item">
							<label class="form-label">配置key</label>
							<div class="form-text form-input-block">
								<input name="info[set_key]" id="username" type="text" class="dfinput" datatype="*5-20" errormsg="配置key范围在5~20位之间！" maxlength="20" />
						...
						<div class="form-item">
							...
							<div class="form-text form-input-block">
								<textarea name="info[set_value]" id="username" class="dftextarea" datatype="*1-500" errormsg="配置值范围在1~500位之间！" maxlength="500" style="width:100%;outline: 0;border: 1px solid #e6e6e6;"></textarea>
								<i class="Validform_checktip"></i>
							</div>
						</div>
						<div class="form-item">
							...
							<div class="form-text form-input-block">
								<input name="info[set_remark]" id="username" type="text" class="dfinput" datatype="*1-20" errormsg="配置详情范围在1~20位之间！" maxlength="20" />
								<i class="Validform_checktip"></i>
							</div>
						</div>
						<div class="form-item">
