		...
		<div class="right_min">
			<div class="crumbs_nav">
				...
				<ul>
					...
					<li> > </li>
					<li><a href="javascript:void(0);">学员等级统计</a></li>
				</ul>
			</div>
			<div class="min">
				<!--查询-->
				...
				<div class="query">
					<form  name="seachform" id="seachform"  action="<?php echo U('tongji/levelinfo');?>"  method="post" class="form"  onsubmit="return checkkwd()">
						...
						<div class="button mg_trb">
							...
							<input type="button" value="重置" class="but chongzhi" onclick="location.href='<?php echo U('tongji/levelinfo');?>'"/>
						</div>
