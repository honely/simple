...
<div class="right_min">
    <div class="crumbs_nav">
        ...
        <ul>
            ...
            <li> > </li>
            <li><a href="javascript:void(0);">修改幻灯宣传</a></li>
        </ul>
    </div>
    <div class="min">
        <div class="form_box">
            <form name="myform" id="myform" action="<?php echo U('focus/edit',array('focus_id'=>$focus['focus_id']));?>" method="post">
                <div class="form-item">
                    <input type="hidden" name="focus_id" value="<?php echo ($focus["focus_id"]); ?>"/>
                    <label class="form-label">标题</label>
                    <div class="form-text form-input-block">
                        <input name="focus_title" value="<?php echo ($focus["focus_title"]); ?>" id="focus_title" type="text" class="dfinput" datatype="*1-20" errormsg="标题字数在2~20位之间！" maxlength="20" />
                ...
                <div class="form-item">
                    ...
                    <div class="form-select form-input-block">
                        <select name="focus_type" class="dfinput" >
                            <option value="">--请选择幻灯类型--</option>
                            <?php if(is_array($focusType)): $i = 0; $__LIST__ = $focusType;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" <?php if($focus['focus_type'] == $key): ?>selected<?php endif; ?>><?php echo ($data); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
                </div>
                <div class="form-item">
                    ...
                    <div class="form-text form-input-block">
                        <input name="focus_url" value="<?php echo ($focus["focus_url"]); ?>" id="focus_url" type="url" class="dfinput"/>
                        <i class="Validform_checktip"></i>
                    </div>
                </div>
                <div class="form-item">
                    ...
                    <div class="form-text form-input-inline w40">
                        <input type="text" name="focus_image" id="image" value="<?php echo ($focus["focus_image"]); ?>" datatype="*" errormsg="请上传图片!" placeholder="请上传图片" readonly/>
                        <i class="Validform_checktip"></i>
                ...
                <div class="form-item">
                    ...
                    <div class="form-select form-input-block">
                        <select name="focus_sort" class="dfinput" datatype="*" errormsg="请选选择排列序号!" >
                            ...
                            <?php if(is_array($focusOrder)): $i = 0; $__LIST__ = $focusOrder;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>" <?php if($focus['focus_sort'] == $key): ?>selected<?php endif; ?>><?php echo ($data); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
                </div>
                <div class="form-item">
