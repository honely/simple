...
<html>
	...
	<body>
		<div class="right_min">
			...
			<div class="min">
				<div class="form_box">
						<form  name="myform" id="myform" action="<?php echo U('content/addcontent');?>" method="post" onsubmit="return check()">
						<div class="form-item">
							...
							<div class="form-select form-input-block">
								<select id="classtype" name="info[classtype]" >
								 <option value="" >--请选择--</option>
									<?php if(is_array($class_type)): $i = 0; $__LIST__ = $class_type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>"><?php echo ($data); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
								</select>
