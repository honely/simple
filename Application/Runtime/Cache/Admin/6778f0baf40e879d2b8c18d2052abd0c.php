...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/Public/admin/css/left.css"/>
		<script src="/Public/admin/js/jquery-1.10.2.min.js" type="text/javascript" charset="utf-8"></script>
		<script src="/Public/admin/js/divscroll.js" type="text/javascript" charset="utf-8"></script>
	</head>
	<body class="left-body">
		<div class="left_box">
			<div class="left-top">
				<img src="/Public/admin/images/logo.jpg">
			</div>
		</div>
