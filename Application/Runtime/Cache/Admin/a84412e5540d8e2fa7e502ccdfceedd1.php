...
<html>
	...
	<body>
		<div class="right_min">
			...
			<div class="min">
				<div class="form_box">
					<form name="myform" id="myform" action="<?php echo U('level/editlevel',array('level_id'=>$level['level_id']));?>" method="post" onsubmit="return check()">
						<div class="form-item">
							<label class="form-label">等级名称</label>
							<div class="form-text form-input-block">
								<input type="text" name="info[level_name]" id="level_name"  placeholder="请输入等级名称" value="<?php echo ($level["level_name"]); ?>" maxlength="20"/>
                        ...
                        <div class="form-item">
							...
							<div class="form-text form-input-block">
								<input type="text" name="info[level_learntime]" id="level_learntime" value="<?php echo ($level["level_learntime"]); ?>"  placeholder="请输入要求学习时长"   onkeyup="value=value.replace(/[^\d.]/g,'')"  " maxlength="10"/>
						...
						<div class="form-item">
							...
							<div class="form-text form-input-block w50">
								<input type="text" name="info[level_score]" id="level_score" value="<?php echo ($level["level_score"]); ?>"  onkeyup="value=value.replace(/[^\d.]/g,'')"  placeholder="请输入奖励学习学分" maxlength="10"/>
						...
						<div class="form-item">
						        <label class="form-label">等级图标</label>
							   	<div class="form-text form-input-inline w50">
									<input type="text" class="form-control" name="info[level_image]" id="level_image"  maxlength="150" value="<?php echo ($level["level_image"]); ?>" readonly />
								</div>
                        ...
                        <div class="form-item">
							...
							<div class="form-textarea form-input-block">
								<textarea name="info[level_remark]" placeholder="请输入简介内容"  id="level_remark"><?php echo ($level["level_remark"]); ?></textarea>
