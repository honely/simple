...
<html>
	...
	<body>
		...
		<div class="login_box">
			<div class="login">
				<h4 class="head">简异思维管理系统</h4>
				<dl>
					<dt><img src="/Public/admin/images/dt_img.png"/></dt>
					<dd>
						<h4>
							<span>用户登录</span>
						...
						<form  name="myform" id="myform" action="<?php echo U('login/login');?>" method="post" class="form">
							<div class="text">
								...
								<p><input name="username" id="username" type="text" class="loginuser" value="" placeholder="请输入登录用户名" datatype="*5-15" errormsg="用户名范围在5~15位之间！" maxlength="20" /></p>
							</div>
							<div class="password">
