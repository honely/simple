    ...
    <div class="center">
        <div class="center_box"  style="display: block;">
            <div class="twlb_box pd_lr06">
                ...
                <input type="hidden" value="<?php echo ($user_auth); ?>"/>
                <div class="ct">
                    <?php if($lessonNum > 1): foreach($tuijian AS $k=>$v):?>
                        <?php if($v['lesson_id'] != $lesson_id): ?><dl class="twlb c"  >
                                <dd>
                                    <div class="top">
            ...
            <?php if($user_auth != 1): ?><div class="button_box pd_lr06" style="background: #fff;">
...
<script>
    ...
    var player = new prismplayer({
        ...
        cover: "<?=$lesson['lesson_image']?>", //播放器默认封面图片
    ...
    player.on("ended", function () {
        ...
        if (url_play!='0') {
            location.href="<?php echo U('course/popular');?>&lesson_id="+url_play;
        }
    });
    ...
    function tiaozhuan(){
        ...
        location.href="<?php echo U('course/popaudio',array('lesson_id'=>$lesson['lesson_id']));?>";
