            ...
            <div class="tjlb" style="margin-bottom: 4.5rem;">
                ...
                <ul>
                    <?php foreach($tuijian AS $k=>$v):?>
                        <li class="c">
                            <a href="<?= U('course/audio',array('course_id'=>$v['course_id']))?>" class="c">
                                <span><?= $v['course_name']?></span>
                                <em><?=$v['course_buy']?>订阅</em>
                            </a>
                        </li>
                    <?php endforeach;?> 
                </ul>
    ...
    events: function()
    {
        ...
        switch( action )
        {
          case "prev": 
              ...
              if(prev_margin < 0){
                ...
                window.location.href="<?= U('course/audio',array('course_id'=>$course[course_id]))?>&margin="+prev_margin;
          ...
          case "next": 
              ...
              if(next_margin >= <?= $count_lesson?>){ 
                ...
                window.location.href="<?= U('course/audio',array('course_id'=>$course[course_id]))?>&margin="+next_margin;
      ...
      self.$domPlaylist.on("click", ".jAudio--playlist-item", function(e)
      {
       ...
       clearInterval(sh);
        ...
        window.location.href="<?= U('course/audio',array('course_id'=>$course[course_id]))?>&margin="+index;
...
<script>
            ...
            $(".jAudio--player").jAudio(t);
             ...
             //跳转到视频播放
            function tiaozhuan(){ 
               location.href="<?php echo U('course/video',array('course_id'=>$course['course_id'],'lesson_id'=>$current_lesson_id));?>"; 
            }
